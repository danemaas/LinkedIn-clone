...
export const SearchDropdownOverlay = ({ dropdown }) => {
  ...
  return (
    <div className="w-full h-full absolute">
      <div className="w-full min-h-[100vh] bg-black/70 fixed top-[4rem] left-0 z-10 overflow-hidden" />
      <section
        className={`bg-white w-[500px] h-[300px] text-black
        fixed z-[100] rounded-md shadow-md shadow-slate-600 ${
          dropdown
            ? "translate-y-[2.5rem] origin-top duration-500"
